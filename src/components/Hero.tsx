...
export const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-b from-background via-secondary/30 to-background">
      ...
      <div className="absolute inset-0" style={{ transform: 'translateY(110px)' }}>
      ...
      >
        <div className="max-w-4xl mx-auto text-center space-y-6 animate-fade-in -mt-16">
          ...
          <p className="text-3xl md:text-5xl text-foreground font-bold drop-shadow-[0_0_30px_rgba(0,0,0,0.9)] [text-shadow:_0_2px_8px_rgba(209,175,102,0.3)] tracking-wide" style={{ WebkitTextStroke: '0.5px rgba(209, 175, 102, 0.6)' }}>
