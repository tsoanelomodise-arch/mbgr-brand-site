  ...
  return (
    <section className="relative min-h-[100svh] flex items-center justify-center overflow-hidden bg-background">
        ...
        {heroImages.map((image, index) => (
          <div
            ...
            style={{
              ...
              transition: `transform 0.1s ease-out, opacity ${isShuffling ? "0.13s" : "2s"} ease-in-out`,
            }}
          >
      ...
      <div className="absolute top-0 left-0 right-0 z-20 container mx-auto px-4">
        <div className="max-w-4xl mx-auto flex items-center h-16 md:h-20 pt-12 md:pt-14">
          <img
            src={mbgLogo}
            alt="MY BRAND GROUP - South Africa's leading vehicle replacement specialists"
            className="h-14 sm:h-16 md:h-20 drop-shadow-2xl"
            loading="eager"
          />
        </div>
      </div>
      ...
      >
        <div className="max-w-4xl mx-auto text-center space-y-4 md:space-y-6 animate-fade-in mt-44 md:mt-64">
